...
2. Online demo:  [Huggingface](https://huggingface.co/spaces/akhaliq/GFPGAN) (return only the cropped face)  **|** [Replicate.ai](https://replicate.com/xinntao/gfpgan) (need to sign in, return the whole image)
3. We provide a *clean* version of GFPGAN, which can run without CUDA extensions. So that it can run in **Windows** or on **CPU mode**.
