...
2. Online demo: [Replicate.ai](https://replicate.com/xinntao/gfpgan) (return the whole image) **|**  [Huggingface](https://huggingface.co/spaces/akhaliq/GFPGAN) (return only the cropped face)
